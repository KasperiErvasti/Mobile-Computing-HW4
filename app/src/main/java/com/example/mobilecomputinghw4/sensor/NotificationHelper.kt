...
import com.example.mobilecomputinghw4.MainActivity
...
class NotificationHelper(private val activity: Activity) {
    ...
    fun requestNotificationPermissions(launcher: ActivityResultLauncher<String>) {
        if (ActivityCompat.checkSelfPermission(
            ...
            createNotification("Testing NOTIFICAATO", "JOTAIN HIENOA")
        }
    }
